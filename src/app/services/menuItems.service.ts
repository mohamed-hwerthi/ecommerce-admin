...
export class MenuItemsService extends BaseService {
  ...
  private readonly menuItemCreatedSource = new BehaviorSubject<MenuItem | null>(null);
  private readonly menuItemUpdatedSource = new BehaviorSubject<MenuItem | null>(null);
  private  readonly  menuItemDeletedSource = new BehaviorSubject<number | undefined | null>(null);
  private readonly  reviewSubmittedSource = new BehaviorSubject<void>(undefined);
