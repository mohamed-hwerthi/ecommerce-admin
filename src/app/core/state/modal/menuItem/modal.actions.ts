...
export const openUpdateMenuItemModal = createAction(
  '[Modal] Open Update MenuItem Modal',
  props<{ menuItem: MenuItem }>(),
);
export const closeUpdateMenuItemModal = createAction('[Modal] Close Update MenuItem Modal');

export const openDeleteMenuItemModal = createAction(
  '[Modal] Open Delete MenuItem Modal',
  props<{ menuItemId: number | undefined }>(),
);
